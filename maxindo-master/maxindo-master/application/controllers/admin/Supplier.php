...
class Supplier extends CI_Controller{
	...
	function getparams(){
		...
		$this->params['table'] = "suppliers";
		$this->params['sql'] = "SELECT SUPPLIERID,suppliers.NAME,cities.NAME AS CITY,ADDRESS,PHONE,EMAIL,BUSINESSFIELD
		FROM suppliers
	...
	function getfieldselect(){
		$this->params['fieldselect']=array(
			...
			'BUSINESSFIELD' => array(
				...
				'type' => "function",
				'model' => "Mmasterdata",
				'func' => "showSupplierBusinessFiled"
			),
			'CITY' => array(
				'class' => "sorting",
			),
