...
class Businessfield extends CI_Controller{
	...
	function getparams(){
		...
		$this->params['name'] = $this->lang->line("businessfield");
		$this->params['table'] = "businessfields";
		$this->params['sql'] = "SELECT * FROM businessfields
		";
