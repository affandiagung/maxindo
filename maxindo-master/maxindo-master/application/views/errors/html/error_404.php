...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo $base_url . "/assets/admin/"; ?>/app/custom/error/error-v6.default.css" rel="stylesheet" type="text/css" />
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v6" style="background-image: url(<?php echo $base_url . "/assets/admin/"; ?>/media//error/bg6.jpg);">
