...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title><?php echo $config->APP_NAME; ?> | Login</title>
		...
		<link href="<?php echo base_url("assets/admin") ?>/plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-static page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35 col-12">
						<!--begin::Logo-->
						<a href="<?php echo site_url(); ?>" class="text-center pt-2">
							<img src="<?php echo base_url("uploads/" . $config->APP_LOGO_HEADER) ?>" class="max-h-75px" alt="" />
							<h1 class="text-info"><?php echo $config->OFFICE_NAME; ?></h1>
						</a>
						<!--end::Logo-->
						<!--begin::Aside body-->
						<div class="d-flex flex-column-fluid flex-column flex-center">
							...
							<div class="login-form login-signin py-11">
								...
								<form class="form" novalidate="novalidate" id="kt_login_signin_form">
									...
									<div class="text-center pb-8">
										...
										<a href="javascript:;" class="text-info font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">Lupa Password ?</a>
									</div>
									<!--end::Title-->
									<!--begin::Form group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Username</label>
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="username" id="username" autocomplete="off" />
									</div>
									<!--end::Form group-->
									<!--begin::Form group-->
									<div class="form-group">
									...
									<div class="text-center pt-2">
										<button type="submit" id="kt_login_signin_submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Log In</button>
									</div>
									<!--end::Action-->
								</form>
								<!--end::Form-->
							...
							<div class="login-form login-signup pt-11">
								...
								<form class="form" novalidate="novalidate" id="kt_login_signup_form">
									...
									<div class="text-center pb-8">
										...
										<p class="text-muted font-weight-bold font-size-h4">Masukkan email Anda untuk melakukan reset password</p>
									</div>
									<!--end::Title-->
									<!--begin::Form group-->
									<div class="form-group">
							...
							<div class="login-form login-forgot pt-11">
								...
								<form class="form" novalidate="novalidate" id="kt_login_forgot_form">
									<!--begin::Title-->
									<div class="text-center pb-8">
										<h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Anda lupa password Anda ?</h2>
				...
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
					...
					<div class="d-flex flex-column justify-content-center text-center pt-lg-40 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
						<h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;"><?php echo $config->APP_SHORTNAME; ?></h3>
						<p class="font-weight-bolder font-size-h2-md font-size-lg text-dark opacity-70"><?php echo $config->APP_NAME; ?></p>
					</div>
					<!--end::Title-->
					<!--begin::Image-->
					<div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(<?php echo base_url("assets/admin"); ?>/media/svg/illustrations/login-visual-2.svg);"></div>
					<!--end::Image-->
				</div>
				<!--end::Content-->
			</div>
		...
		<script src="<?php echo base_url("assets/admin") ?>/plugins/custom/prismjs/prismjs.bundle.js"></script>
		<script src="<?php echo base_url("assets/admin") ?>/js/scripts.bundle.js"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="<?php echo base_url("assets/admin") ?>/js/pages/custom/login/login.js"></script>
		<script type="text/javascript">
