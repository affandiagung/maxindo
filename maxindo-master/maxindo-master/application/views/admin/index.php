...
<html lang="en">
	...
	<head><base href="">
		...
		<!-- <link href="<?php echo base_url('assets/admin13'); ?>/plugins/custom/datatables/datatables.dark.bundle.css" rel="stylesheet" type="text/css" /> -->
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								foreach( $menus as $menu ){
									...
									if( count($child1) == 0 ){
										...
										<a class="menu-link main-menu" '.((@$menu->NEWTAB == 1) ? 'target="_blank"' : null) .' href="'.site_url( $homepage ."/" . $menu->URL).'">
										...
										foreach($child1 as $ch1){
											...
											if( count($child2) == 0 ){
												$renderMenu .= '<div class="menu-item">
												<a class="menu-link main-menu" '.((@$ch1->NEWTAB == 1) ? 'target="_blank"' : null) .' href="'.site_url( $homepage ."/" . $ch1->URL).'">
												...
												foreach($child2 as $ch2){
													$renderMenu .= '<div class="menu-item">
													<a class="menu-link main-menu" '.((@$ch2->NEWTAB == 1) ? 'target="_blank"' : null) .' href="'.site_url( $homepage ."/" . $ch2->URL).'">
													<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
													</span>
		...
		<!--end::Scrolltop-->
		<!-- begin:: Modal -->
		<div class="modal fade" id="engineModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		...
		<!-- end:: Modal -->
		<!-- begin:: Modal Popup -->
		<div class="modal fade" id="popupModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-content">
					<div class="modal-header">
		        <h5 class="modal-title"></h5>
		...
		<!-- end:: Modal Popup -->
		<!-- begin:: Modal Popup -->
		<div class="modal fade" id="inputModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl">
				<div class="modal-header">
		        <h5 class="modal-title"></h5>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				...
				<div class="modal-content">
					<div class="modal-body" id="modalInputContainer">

					</div>
					<div class="modal-footer" id="modalInputFooter">
						<button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fas fa-times"></i> Close</button>
						<button type="button" style="display:none;" onclick="print('modalInputContainer');" id="btn-print-input" class="btn btn-primary"><i class="fa fa-print"></i> Print</button>
						<button type="button" style="display:none;" id="btn-save-popup" class="btn btn-primary"><i class="fa fa-save"></i> Save</button>
					</div>
				</div>
			</div>
		...
		<!-- <script src="<?php echo base_url('assets/admin13'); ?>/js/scripts.bundle.new.js"></script> -->
		...
		<!-- <script src="<?php echo base_url('assets/admin13'); ?>/js/widgets.bundle.new.js"></script> -->
		<script src="<?php echo base_url('assets/admin13'); ?>/js/kalender.js"></script>
		...
		<script src="<?php echo base_url('assets/admin13'); ?>/plugins/custom/vis-timeline/vis-timeline.bundle.js"></script>
